...
La Versión 3.2 también introduce la nueva Especialidad de Agente **Armorer**, nuevo contenido de historia, eventos por tiempo limitado, recompensas gratis, nuevos atuendos, mejoras de combate y contenido adicional para los sistemas existentes del juego.
...
| Agente         | Rango | Atributo | Especialidad | Estado     |
| -------------- | ----: | -------- | ------------ | ---------- |
| **Claret**     |     S | Electric | Armorer      | NUEVO      |
| **Roxy**       |     S | Wind     | Stun         | NUEVO      |
| **Nangong Yu** |     S | Ether    | Stun         | RE-EMISIÓN |
| **Promeia**    |     S | Ice      | Anomaly      | RE-EMISIÓN |
...
Está asociada con **Flint Workshop** y usa un sistema de daño orientado a DEF con mecánicas como **Gash**, **Maim** y **Laceration**.

Su kit convierte a DEF en una stat ofensiva importante en lugar de tratarla solo como un atributo defensivo.

### Resumen de build de Claret
...
Ubicación:
Colocar directamente después de la introducción del personaje y antes de la tabla de build.
...
> **Nota de build:** Las combinaciones óptimas finales de Disc Drive de Claret pueden depender de la composición del equipo y del balance más reciente del juego en vivo. Prioriza primero las stats principales correctas y luego optimiza las substats.
...
Es un **Agente Wind Stun** y está asociada con **Flint Workshop**.

Su gameplay gira en torno a su Ataque Especial EX y los **Eyes of the Storm**, permitiéndole contribuir con presión sostenida mientras cumple el rol de Stun.

### Resumen de build de Roxy

**Rol recomendado:**

- Stun
- Generación de Daze
- Soporte de equipo a través de ventanas de Stun
...
Ubicación:
Inmediatamente después de la introducción de Roxy.
...
> **Nota de build:** Para un Agente Stun, **Impact** es la stat clave a priorizar al construir en torno a una generación de Daze más rápida.
...
- Alcanza el Nivel 5 de Inter-Knot.
- Desbloquea la función de Eventos.
- Inicia sesión un total de 7 días.
...
Ubicación:
Después de las dos secciones de recompensas gratuitas.
...
Los atuendos disponibles incluyen:
...
| ------------- | ------------------------------------------------------------------------------------------------------ | ------------------------ |
| `ZZZVOID32`   | 20 Polychromes + 2,222 Denny                                                                           | 🟢 Reportado como activo |
| `ZZZINK32`    | 20 Polychromes + 2,222 Denny                                                                           | 🟢 Reportado como activo |
| `ZZZGRIND32`  | 20 Polychromes + 2,222 Denny                                                                           | 🟢 Reportado como activo |
| `ZENLESSGIFT` | 50 Polychromes + 2 Official Investigator Logs + 3 W-Engine Power Supplies + 1 Bangboo Algorithm Module | 🟢 Reportado como activo |

Los tres códigos de la Versión 3.2 han sido reportados como activos por los rastreadores de códigos actuales de septiembre 2026, mientras que `ZENLESSGIFT` también sigue listado como activo. La disponibilidad de los códigos puede variar por cuenta y puede cambiar sin aviso.

### ⚠️ Código de livestream 3.2 expirado

`FLINTWORKS`

Este código otorgaba:
...
Los jugadores que no reclamaron la recompensa de Agente S-Class limitado relevante de la Versión 3.1 pueden elegir entre:

- Jane
- Hugo
- Soldier 0 - Anby

La selección de W-Engine correspondiente incluye:
...
- **Destello dorado:** Asistencia defensiva
- **Destello rojo:** Asistencia de evasión
...
| **Re-emisión**                   | Promeia                |
| **Nueva Especialidad**           | Armorer                |
| **Encrypted Master Tapes gratis**| ×10                    |
| **Boopons gratis**               | ×10                    |
| **Nuevos atuendos**              | Angels of Delusion     |
| **Ubicación de la historia principal** | Vyrium / Shrouded Reef |
| **Fase 1**                       | Claret + Nangong Yu    |
| **Fase 2**                       | Roxy + Promeia         |
