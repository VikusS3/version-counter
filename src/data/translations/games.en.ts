...
export const gamesTranslations: Record<string, GameTranslation> = {
  ...
  "neverness-to-everness": {
    ...
    descripcion:
      "Neverness to Everness 1.4 Countdown for all region like America, Europe, Asia. Genshin Banner Countdown, Patch Notes, and more.",
    slogan_desc:
      "Nerver to Everness 1.4 is now available, new characters, and more.",
